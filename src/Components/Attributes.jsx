                    ...
                    (this.props.USER_AUTH_DATA.isSignedIn)
                        ...
                        (
                            <div>
                                ...
                                <br />
                                <h3 className="text-center text-dark">Post Your Ad</h3>
                                <br />
                                <div id="form">
                                    <br />
                                    ...
                                    <button style={{ marginLeft: "25px" }} onClick={(e) => this.setCondition(e)} type="button" className="btn btn-outline-dark">New</button>
                                    ...
                                    <div style={{maxWidth:"90%"}} id="logindiv">
                                        <br />
                                        <progress style={{ width: "80%", borderRadius: "10px",marginLeft:"30px" }} className="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" value={this.state.progress} max="100" />
                                        <br />
                                        <input className="btn btn-outline-transparent" type="file" style={{ marginLeft: "20px"}} onChange={this.handleChange} /><br />
                                        <button style={{ marginTop: "10px", marginLeft: "30px", marginBottom: "10px" }} className="btn btn-success" onClick={(e) => this.handleUpload(e)}>Upload</button>
                                        <br />
                                        <img src={this.state.ImageURL || 'http://via.placeholder.com/400x300'} style={{maxWidth:"90%",paddingLeft:"30px"}} alt="Uploaded images" height="auto"  />
                                    </div>
                                    {/* Here the uploaded image will be here */}
                             ...
                             <input clas="gettedname" value={firebase.auth().currentUser.displayName} className="text-dark form-control" type="text" />
                                    ...
                                    <button onClick={this.checkAlldata} className="btn btn-success mt-4 mb-4" style={{marginLeft:"25px"}}>I agree to the terms and conditions</button>
                                    ...
                                    ?(
                                        ...
                                        <br/>
                                        <Link to="/phoneauth" onClick={this.move} style={{ fontSize: "20px",marginLeft:"20px" }} className="btn mt-4 mb-4 btn-dark btn-lg" to="/phoneauth">Move Next</Link>
                                        </div>
                                    ):(
