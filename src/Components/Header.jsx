                        ...
                        <ul className="navbar-nav mr-auto">
                            ...
                            <li className="nav-item ml-4">
                                ...
                                {(this.props.USER_AUTH_DATA.isSignedIn) ? (
                                    ...
                                    <div id="DropUser" className="dropdown">
                                        <button type="button" style={{ borderRadius: "50%", width: "35px", height: "35px", marginTop: "-10px", display: "flex" }} data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <img style={{ borderRadius: "50%", width: "35px", height: "35px", marginTop: "-4.4px", marginLeft: "-3.5px" }} src={firebase.auth().currentUser.photoURL} alt="" />
                                            <FontAwesomeIcon style={{ color: "grey", fontWeight: "initial", marginLeft: "5px" }} id="Icon" icon={faAngleDown} />
                                        </button>
                            ...
                            <li className="nav-item">
                                ...
                                {(this.props.USER_AUTH_DATA.isSignedIn) ? (
                                    ...
                                    <Link id="fachat" className="inputDesktop" to="/chat"> <FontAwesomeIcon className="text-dark" style={{ fontSize: "30px", marginLeft: "15px", marginTop: "20px" }} icon={faComment} /></Link>
                                ) : (
                                    <span></span>
                                )
                                }
                            ...
                            <li className="nav-item">
                                {
                                    (this.props.USER_AUTH_DATA.isSignedIn) ?
                                        (
                                            <div className="mt-1">
                                                <Link id="facart" className="inputDesktop mt-4" style={{ fontSize: "15px", border: "1px solid black", borderRadius: "10px", backgroundColor: "white", marginTop: "15px" }} to="/order">(0)<FontAwesomeIcon className="text-dark" style={{ fontSize: "30px", marginTop: "1%" }} icon={faShoppingCart} /></Link>
                                            </div>
                                        ) :
                                        (
                                            <span></span>
                            ...
                            <li className="nav-item">
                                {
                                    (this.props.USER_AUTH_DATA.isSignedIn) ?
                                        (
                                            <Link to="/sell" id="sellbtn" className="btn btn-info mt-3">SELL</Link>
                                        ) :
                                        (
